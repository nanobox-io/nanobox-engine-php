...
create_php_opcache_ini() {
  print_bullet "Generating opcache.ini"
  template \
...
opcache_ini_payload() {
  ...
  print_bullet_sub "Memory consumption: ${_opcache_memory_consumption}"
  print_bullet_sub "Validate timestamps: ${_opcache_validate_timestamps}"
  print_bullet_sub "Revalidate freq: ${_opcache_revalidate_freq}"
  print_bullet_sub "Revalidate path: ${_opcache_revalidate_path}"
  print_bullet_sub "Save comments: ${_opcache_save_comments}"
  print_bullet_sub "Load comments: ${_opcache_load_comments}"
  print_bullet_sub "Enable file override: ${_opcache_enable_file_override}"
  print_bullet_sub "Optimization level: ${_opcache_optimization_level}"
  print_bullet_sub "Dups fix: ${_opcache_dups_fix}"
  print_bullet_sub "Blacklist filename: ${_opcache_blacklist_filename}"
  cat <<-END
{
